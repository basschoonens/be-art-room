-- INSERT INTO artworks (id, title, artist, description, date_created, gallery_buying_price, edition, image_path, artwork_type) VALUES (1001, 'Head of a woman', 'Leonardo da Vinci', 'A drawing of the head of a woman', 15081658, 2000000, 1, 'www.leonardodavinci.com', 'drawing');
-- INSERT INTO artworks (id, title, artist, description, date_created, gallery_buying_price, edition, image_path, artwork_type) VALUES (1002, 'The Scream', 'Edvard Munch', 'De Schreeuw (Noors: Skrik) is de titel van een viertal schilderijen en een lithografie van Edvard Munch uit 1893.', 1011893, 1500000, 1, 'www.edvardmunch.com', 'painting');

INSERT INTO artworks (id, title, artist, description, date_created, gallery_buying_price, edition, image_path, artwork_type) VALUES (1001, 'Head of a woman', 'Leonardo da Vinci', 'A drawing of the head of a woman', '1508-01-01', 2000000, 1, 'uploads/1001-fantail-wrens-McGill.jpg', 'drawing');
INSERT INTO artworks (id, title, artist, description, date_created, gallery_buying_price, edition, image_path, artwork_type) VALUES (1002, 'The Scream', 'Edvard Munch', 'De Schreeuw (Noors: Skrik) is de titel van een viertal schilderijen en een lithografie van Edvard Munch uit 1893.', '1893-10-01', 1500000, 1, 'www.edvardmunch.com', 'painting');
